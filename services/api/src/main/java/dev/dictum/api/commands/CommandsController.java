  ...
  public CommandsResponse listCommands() {
    return new CommandsResponse(
        List.of(
            ...
            new CommandDefinitionResponse(
                "publish_post", "posts", "planned", "Move a draft post into the published state."),
            new CommandDefinitionResponse(
                "set_subtitle", "settings", "planned", "Change the public homepage subtitle."),
            new CommandDefinitionResponse(
                "set_motd", "settings", "planned", "Update the site-wide message of the day.")));
  }
